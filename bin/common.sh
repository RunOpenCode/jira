...
extract_database_url() {
  ...
  case "$(read_var $prefix SCHEME)" in
    ...
    mysql|mysql2)
      ...
      local jdbc_url="jdbc:mysql://$host_port_name?autoReconnect=true&characterEncoding=utf8&useUnicode=true&sessionVariables=default_storage_engine%3DInnoDB&useSSL=false"
